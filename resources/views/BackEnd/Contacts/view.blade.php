                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Контактная форма <strong class="text-primary small"># {{$model->id}}</strong></h3>
                            ...
                            <div class="invoice-wrap">
                                <div class="invoice-head">
                                    <div class="invoice-contact">
                                        <span class="overline-title">Контактная форма к</span>
                                        <div class="invoice-contact-info">
                                            <h4 class="title">FREESUN MOLDOVA от</h4>
                                            <ul class="list-plain">
                                                <li><em class="icon ni ni-user"></em><span>{{$model->name}} {{$model->surname}}</span></li>
